...
teacher = Teacher.new(description: "Développeur Freelance et formé au wagon, je suis fier de pouvoir transmettre à mon tour ce que l'on m'a appris. A part ça j'aime la mer, les bateaux et les div.", specialty: "JavaScript", price: "256", city_name: "Toulon", user_id: user.id)
...
teacher2 = Teacher.new(description: "HAdventures on sailing boats - Keep learning new coding tricks always - Teaching, sharing knowledge - Impact entrepreneurship", specialty: "Ruby", price: "340", city_name: "Marseille", user_id: user2.id)
...
teacher3 = Teacher.new(description: "Data Scientist / Ruby on Rails hobbyist Call me Pilou!", specialty: "SQL", price: "290", city_name: "Lille", user_id: user3.id)
